...
void GameApp::Init()
{
	...
	Player.Init(/*"res/Player/Player.wrl"*/ "res/Player/Player.obj");
	Player.PlayerModel.Physics.Position = Vector(0.0, 20000, 0.0);
	Environment.PlayerPos = &Player.PlayerModel.Physics.Position;
	
	Environment.InitWithSkyBox("res/m", "tga", 200000, "res/ptest.raw" /*"res/Terrain/Terrain.obj"*/, &Player.PlayerModel.Physics.Position);
	//Environment.InitWithSkyPlane("res/cloud.tga", 10, 60000, 100000, "res/ptest.raw", &Player.PlayerModel.Physics.Position);
	//Environment.InitWithSkyDome("res/cloud.tga", 50, 200000, 0.5, "res/ptest.raw", &Player.PlayerModel.Physics.Position);
