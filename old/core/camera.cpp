...
void camerahdl::setup(frustum4f f)
{
	frustum = f;
}
...
void camerahdl::geometry(double t)
{

}

void camerahdl::material(double t)
{

}

void camerahdl::physics(double t)
{
	//update(t);
}

void camerahdl::chemistry(double t)
{
